...
fio --name=RUN_CHECK_DIRECT_IO --ioengine=\$ioengine --direct=1 --gtod_reduce=1 --filename=fiotest.tmp --bs=4k --size=64k --runtime=1 --ramp_time=1 --readwrite=read >/dev/null 2>&1 \x5C
